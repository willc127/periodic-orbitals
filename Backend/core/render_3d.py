...
def render_3d(
    n: int, l: int, m: int, mode: str, filename: str | None = None, cmap: str = "magma"
) -> str | None:
    """
    Renderiza uma visão 3D do orbital atômico.

    Args:
        n: Número quântico principal
        l: Número quântico angular
        m: Número quântico magnético
        mode: Tipo de renderização ('real' ou 'complex')
